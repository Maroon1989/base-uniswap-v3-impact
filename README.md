...
- `output/summary.md`: compact generated metrics snapshot
- `output/advanced_insights.md`: fee-adjusted metrics, peak minute/block tables, candidate rules
- `output/case_receipts.md`: receipt-level spot checks for selected case transactions
...
base-v3-advanced-insights --db data/swaps.db
```

Inspect receipt-level case transactions:

```bash
base-v3-inspect-tx --output output/case_receipts.md \
